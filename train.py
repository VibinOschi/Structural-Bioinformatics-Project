...
from src.utils.training_utils import TwoStageFocalLoss, train_model, save_model_in_directory
...
if __name__ == "__main__":
    ...
    class_weights_stage_1, class_weights_stage_2 = get_class_weights_from_dataframe(dataset.labels[train_dataset.indices].numpy())
